...
class VPRootViewController: UIViewController {
    ...
    /// 主界面下边按钮的子控制器
    let controllers = ["VPTestHeartController","VPTestBloodController","VPTestOxygenController","VPTestRespirationRateController","VPTestSleepController","VPTestStepController","VPMessageRemindViewController","VPBaseFunctionRemindController" ,"VPOterFunctionSettingController"
        ,"VPSOSViewController"]
